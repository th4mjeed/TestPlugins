...
@CloudstreamPlugin
class TmdbMoviesPlugin : BasePlugin() {
    override fun load() {
        registerMainAPI(TmdbMovies())
    }
}

class TmdbMovies : MainAPI() {
    override var name = "TMDB Movies & Shows"
    ...
    override suspend fun loadLinks(
        ...
        // TODO: plug in MoviesApi / RiveStream / Vidlink extractor here
        return false
    }
